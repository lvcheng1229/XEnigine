    ...
    )
{
    ...
    Parameters.TangentToWorld2 = Input.TangentToWorld2.xyz;
    ...
    OutTargetB=float4(OutputGbufferData.Metallic,OutputGbufferData.Specular,OutputGbufferData.Roughness,OutputGbufferData.ShadingModel);
